  ...
  return (
    <div className="flex flex-col min-h-screen items-center bg-[#0d0221] font-mono relative overflow-hidden text-cyan-50">
      ...
      <div className="relative z-10 w-full flex flex-col items-center flex-1">
        ...
        {isLoading ? (
          <main className="flex flex-1 w-full items-center justify-center py-12 px-6">
            <div className="flex flex-col items-center gap-6 animate-pulse bg-[#0a001a]/85 border-2 border-cyan-500 p-10 shadow-[0_0_30px_rgba(34,211,238,0.2)]">
              <span className="text-5xl text-cyan-400 drop-shadow-[0_0_15px_rgba(34,211,238,0.8)]">⏳</span>
              <h2 className="text-xl md:text-2xl font-black tracking-widest text-pink-500 drop-shadow-[0_0_15px_rgba(236,72,153,0.8)] uppercase text-center">
